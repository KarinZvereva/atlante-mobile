...
export function Info(props: any) {
  ...
  const [countGlobal, setGlobalCount] = useState<number | undefined>(undefined);
  const [countRegion, setRegionCount] = useState<number | undefined>(undefined);
  const [countProvince, setProvinceCount] = useState<number | undefined>(undefined);
  ...
  const loadCount = 
    (countType : CountType, data: string | undefined) => {
      setError('');
      setIsError(false);
      ...
      infoCountCall.count({region, province})
      .then((result) => {
        if (result ) {
          switch (countType) {
            case CountType.Region :
      ...
      {!isLoading && (
        ...
        <ScrollView style={styles.scroll_container}>
          <View style={styles.centered_container}>
            ...
            <Text style={[styles.infoText]}>Se anche tu, Bevitore Errante,</Text>
            <Text style={[styles.infoText]}>
